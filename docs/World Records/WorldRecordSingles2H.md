...
<AnimCube params="config=/static/ReconstructionConfig.txt&move=x2 y.D' R u D R' y' D' R D R'.y D r' E' L.z2 U y l D R' z' R' x z' r' R2 U2 z D R2 D2.R' l' z M D2 M'.z2 y R z' M z R'.z' r' L' z D R' E R.U' u' R E' R'.u R' E' R E2 R E R'.R2 E E' r2 E M2 E'&initmove=U L2 D' B2 U' R2 B2 F2 D' F2 L2 R2 F R2 D L2 R2 B' L' D' R F'" width="400px" height="400px" />
