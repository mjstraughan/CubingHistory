...
According to Ron van Bruchem, the technique appears two months later in December 1981 in a book by Frans Schiereck called De Hongaarse Kubus Voor Doordraaiers.
...
For several years in the online community, it was believed that the totality of CFOP had been created by Jessica Fridrich. However, some in the community were aware of the 1981 Cubism for Fun newsletter and the appearance of the F2L pair technique in the mentioned books. In July, 2003, Ryan Heise posed the question to the community as to the origin of the F2L pair technique. Jessica Fridrich responded by saying that she wasn't sure herself. She learned of the technique from friends in college. They had been using the technique, although in a basic form. Fridrich found solutions for additional cases and those are included on her website.

![](img/CFOP/F2L/Fridrich1.png)

Before developing her website, Fridrich described the method on the Cube Lovers mailing list.

![](img/CFOP/F2L/Fridrich2.png)

Fridrich developed the website for the method in January, 1997.
...
Jessica Fridrich published the OLL and PLL algorithms in a 1982 issue of Mladý Svět.

![](img/CFOP/OLLPLL/MladySvet.png)
![](img/CFOP/OLLPLL/MladySvet2.png)

http://www.math.rwth-aachen.de/~Martin.Schoenert/Cube-Lovers/%5bunknown_name%5d__Re__Thistlethwaites_algorithm_(and_others).html
...
The OLL numbering system was initially created by Jessica Fridrich. Fridrich had the cases numbered on her site. However, mirrors weren't included, as was common during those years.

![](img/CFOP/OLLPLL/OLLNumbers1.png)

The OLL numbers were expanded upon by the Japanese community to include mirror cases.
...
https://web.archive.org/web/20040810081051/http://naitsu.hp.infoseek.co.jp/orient.htm

https://web.archive.org/web/20040604123828/http://www2.u-netsurf.ne.jp/~katsu-k/

https://web.archive.org/web/20040602231224/http://cubefreak.hp.infoseek.co.jp/OLL.html

### PLL Letter Names

The PLL letter names were created by Mirek Goljan and appear on Fridrich's site. As with OLL, mirrored cases weren't included. The system of adding a lower case a, b, c, or d after the uppercase letter was added later by the community.
...
>The first message is from Dan Knights and the second is from Lars Vandenbergh. It is likely that early talks of ensuring that the LL edges are oriented is that led to the ZBLS idea.

The earliest found mention of the term "edge control" is by Shotaro Makisumi starting in 2004. Makisumi eventually created a page on his site to describe the technique.
...
https://web.archive.org/web/20050320040335/https://www.speedcubing.com/chris/zbf2l.html

https://www.speedcubing.com/chris/zbf2l.html

### Pseudo Slotting

Olly Hayden discussed the technique and called it non-matching pairs in May, 2002. This is the earliest known mention of the technique.
...
https://web.archive.org/web/20021002082650/http://homepage.ntlworld.com/angela.hayden/cube/speed4.html

Jessica Fridrich briefly mentioned the technique on her site on August 26, 2002.

![](img/CFOP/Techniques/PseudoSlotting2.png)
http://www.ws.binghamton.edu/fridrich/examples.html

>Thanks to Filipe Teixeira for finding this on Fridrich's website.

That specific page was created after Olly Hayden's description and website.

![](img/CFOP/Techniques/PseudoSlotting3.png)
![](img/CFOP/Techniques/PseudoSlotting4.png)

Pseudo slotting went through a few name changes over time. Olly Hayden called it non-matching pairs and that name is also used on Shotaro Makisumi's website. It was also called "slant pairing" by some in the community.
