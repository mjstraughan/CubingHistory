// Adapted from https://github.com/cubing/react-cubing/blob/main/src/TwistyPlayer/index.tsx
import {
  useState,
  useEffect,
  forwardRef,
...
const TwistyPlayer = forwardRef(
  ({ className, rootClassName, rotateStickering, ...props }, ref) => {
    const [twistyPlayer, setTwisty] = useState();
...
async function transformTPMask(twisty, transformationSource) {
